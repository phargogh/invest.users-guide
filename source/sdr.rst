...
* **[Workspace]\\intermediate_outputs** folder:
    ...
    * **what_drains_to_stream.tif**: Identifies areas that were in the DEM and whether a pixel drains to a stream. See :ref:`this section <sdr_defined_area>` for more information.
